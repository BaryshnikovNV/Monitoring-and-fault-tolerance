...
Скриншот-1 - Скриншот systemctl status prometheus, где написано: prometheus.service — Prometheus Service Netology Lesson 9.4 — [Baryshnikov NV].
...
Скриншот-2 - Скриншот systemctl status node-exporter, где написано: node-exporter.service — Node Exporter Netology Lesson 9.4 — Baryshnikov NV.
